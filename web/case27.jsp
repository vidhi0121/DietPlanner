...
<table align="center">
  ...
  <tr>
    <td>Early Morning</td>
    <td>Soaked Almonds<br>Herbal Tea or Black Tea/Coffe<br> Biscuits</td>
    <td>4<br>1 cup<br>2</td>
  </tr>
  <tr>
    <td>Breakfast</td>
    <td>Cold Cereals<br>Coconut water<br>Banana</td>
  ...
  <tr>
    <td>Evening</td>
    <td>Bread Slice(with 4 teaspoon of jelly and 2 spoon peanut butter)</td>
    <td>2</td>
  </tr>
  <tr>
    <td>Dinner</td>
    <td>Chapati<br>Chicken(with mayonnise)<br>Curd/Kadhi/dal</td>
