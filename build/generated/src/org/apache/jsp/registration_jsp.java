...
public final class registration_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("            <a href=\"index.html\"> <img src=\"71.jpg\" height=\"20\" width=\"20\"/></a>&nbsp;&nbsp;\n");
      out.write("\t\t<input id=\"tab-1\" type=\"radio\" name=\"tab\" class=\"sign-in\"/><label for=\"tab-1\" class=\"tab\">Sign In</label>\n");
      out.write("\t\t<input id=\"tab-2\" type=\"radio\" name=\"tab\" class=\"sign-up\"checked/><label for=\"tab-2\" class=\"tab\">Sign Up</label>\n");
      out.write("                \n");
      out.write("                <div id=\"new\" class=\"login-form\">\n");
      out.write("\t\t\t<div id=\"ggg\" class=\"sign-in-htm\">\n");
      out.write("                            <form action=\"LoginTest\" method=\"post\">\n");
      out.write("                            \n");
      out.write("\t\t\t\t<div class=\"group\">\n");
      out.write("\t\t\t\t\t<label for=\"user\" class=\"label\">Email Address</label>\n");
      out.write("\t\t\t\t\t<input id=\"user\" type=\"email\" class=\"input\" name=\"email\"/>\n");
      out.write("\t\t\t\t</div>\n");
      out.write("\t\t\t\t<div class=\"group\">\n");
      out.write("\t\t\t\t\t<label for=\"pass\" class=\"label\">Password</label>\n");
      out.write("\t\t\t\t\t<input id=\"pass\" type=\"password\" name=\"pass\" class=\"input\" data-type=\"password\"/>\n");
      out.write("\t\t\t\t</div>\n");
      out.write("\t\t\t\t<div class=\"group\">\n");
      ...
      out.write("\t\t\t\t\t<input id=\"pass\" type=\"text\" class=\"input\" name=\"name\"/>\n");
      out.write("\t\t\t\t</div>\n");
      out.write("\t\t\t\t<div class=\"group\">\n");
      out.write("\t\t\t\t\t<label for=\"user\" class=\"label\">Password</label>\n");
      out.write("\t\t\t\t\t<input id=\"user\" type=\"password\" class=\"input\" name=\"pass\"/>\n");
      out.write("\t\t\t\t</div>\n");
      out.write("                                 <div class=\"group\">\n");
      out.write("\t\t\t\t\t<label for=\"pass\" class=\"label\">Confirm Password</label>\n");
      out.write("\t\t\t\t\t<input id=\"pass\" type=\"password\" class=\"input\" name=\"cpass\"/>\n");
      out.write("\t\t\t\t</div>\n");
      out.write("\t\t\t\t<div class=\"group\">\n");
      out.write("\t\t\t\t\t<label for=\"pass\" class=\"label\">Email Address</label>\n");
      out.write("\t\t\t\t\t<input id=\"pass\" type=\"email\" class=\"input\" name=\"email\"/>\n");
      out.write("\t\t\t\t</div>\n");
      out.write("\t\t\t\t\n");
      out.write("\t\t\t\t\n");
      out.write("\t\t\t\t<div class=\"group\">\n");
